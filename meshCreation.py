...
def main():
    ...
    parser.add_argument("-i", "--input", help="Input las file (default ='./ExampleData.las')", default="./ExampleData.las")
        ...
        if(len(islands[index]) > 8):
            ...
            if(islands_size[index] < 50):
                try:
                    ...
                    o3d.io.write_triangle_mesh(output_path+"hull_"+ str(index) +".ply", hull, write_vertex_colors=True)
                ...
                try:
                    ...
                    alphashapeTree.export(output_path+"obj/alpha_"+ str(index) +".obj")
    ...
    PLYConverter.convert2(output_path)
